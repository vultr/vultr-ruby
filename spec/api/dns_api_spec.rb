...
# Unit tests for VultRuby::DnsApi
...
describe 'DnsApi' do
  ...
  describe 'test an instance of DnsApi' do
    it 'should create an instance of DnsApi' do
      expect(@api_instance).to be_instance_of(VultRuby::DnsApi)
    end
  end

  # unit tests for create_dns_domain
  # Create DNS Domain
  ...
  describe 'create_dns_domain test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_dns_domain_record
  # Create Record
  # Create a DNS record.
  ...
  describe 'create_dns_domain_record test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for delete_dns_domain_record
  # Delete Record
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_dns_domain_record test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_dns_domain_dnssec
  # Get DNSSec Info
  # Get the DNSSEC information for the DNS Domain.
  # @param dns_domain The [DNS Domain](#operation/list-dns-domains).
  # @param [Hash] opts the optional parameters
  # @return [GetDnsDomainDnssec200Response]
  describe 'get_dns_domain_dnssec test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_dns_domain_record
  # Get Record
  ...
  # @param [Hash] opts the optional parameters
  # @return [CreateDnsDomainRecord201Response]
  describe 'get_dns_domain_record test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_dns_domain_soa
  # Get SOA information
  # Get SOA information for the DNS Domain.
  # @param dns_domain The [DNS Domain](#operation/list-dns-domains).
  # @param [Hash] opts the optional parameters
  # @return [GetDnsDomainSoa200Response]
  describe 'get_dns_domain_soa test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_dns_domain_records
  # List Records
  ...
  describe 'list_dns_domain_records test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_dns_domains
  # List DNS Domains
  ...
  describe 'list_dns_domains test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_dns_domain
  # Update a DNS Domain
  ...
  # @return [nil]
  describe 'update_dns_domain test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_dns_domain_record
  # Update Record
  ...
  # @return [nil]
  describe 'update_dns_domain_record test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_dns_domain_soa
  ...
  # @return [nil]
  describe 'update_dns_domain_soa test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
