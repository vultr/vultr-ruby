...
# Unit tests for VultRuby::RegionApi
...
describe 'RegionApi' do
  ...
  describe 'test an instance of RegionApi' do
    it 'should create an instance of RegionApi' do
      expect(@api_instance).to be_instance_of(VultRuby::RegionApi)
    end
  end

  # unit tests for list_available_plans_region
  ...
  describe 'list_available_plans_region test' do
    it 'should work' do
