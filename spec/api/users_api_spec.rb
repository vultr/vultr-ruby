...
# Unit tests for VultRuby::UsersApi
...
describe 'UsersApi' do
  ...
  describe 'test an instance of UsersApi' do
    it 'should create an instance of UsersApi' do
      expect(@api_instance).to be_instance_of(VultRuby::UsersApi)
    end
  end
  ...
  # @option opts [CreateUserRequest] :create_user_request Include a JSON object in the request body with a content type of **application/json**.
  # @return [User]
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [Float] :per_page Number of items requested per page. Default is 100 and Max is 500.
  ...
  # @param user_id The [User id](#operation/list-users).
  # @param [Hash] opts the optional parameters
  # @option opts [UpdateUserRequest] :update_user_request Include a JSON object in the request body with a content type of **application/json**.
  # @return [nil]
