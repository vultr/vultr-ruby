...
# Unit tests for VultRuby::StartupApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'StartupApi' do
  before do
  ...
  describe 'test an instance of StartupApi' do
    it 'should create an instance of StartupApi' do
      expect(@api_instance).to be_instance_of(VultRuby::StartupApi)
    end
  end

  # unit tests for create_startup_script
  ...
  describe 'create_startup_script test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_startup_script
  # Delete Startup Script
  # Delete a Startup Script.
  # @param startup_id The [Startup Script id](#operation/list-startup-scripts).
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_startup_script test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_startup_script
  # Get Startup Script
  # Get information for a Startup Script.
  # @param startup_id The [Startup Script id](#operation/list-startup-scripts).
  # @param [Hash] opts the optional parameters
  # @return [GetStartupScript200Response]
  describe 'get_startup_script test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_startup_scripts
  ...
  describe 'list_startup_scripts test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_startup_script
  ...
  # @return [nil]
  describe 'update_startup_script test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
