...
# Unit tests for VultRuby::FirewallApi
...
describe 'FirewallApi' do
  ...
  describe 'test an instance of FirewallApi' do
    it 'should create an instance of FirewallApi' do
      expect(@api_instance).to be_instance_of(VultRuby::FirewallApi)
    end
  end

  # unit tests for create_firewall_group
  ...
  describe 'create_firewall_group test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_firewall_group
  # Delete Firewall Group
  # Delete a Firewall Group.
  # @param firewall_group_id The [Firewall Group id](#operation/list-firewall-groups).
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_firewall_group test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_firewall_group_rule
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_firewall_group_rule test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_firewall_group
  # Get Firewall Group
  # Get information for a Firewall Group.
  # @param firewall_group_id The [Firewall Group id](#operation/list-firewall-groups).
  # @param [Hash] opts the optional parameters
  # @return [CreateFirewallGroup201Response]
  describe 'get_firewall_group test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_firewall_group_rule
  # Get Firewall Rule
  # Get a Firewall Rule.
  # @param firewall_group_id The [Firewall Group id](#operation/list-firewall-groups).
  # @param firewall_rule_id The [Firewall Rule id](#operation/list-firewall-group-rules).
  ...
  describe 'get_firewall_group_rule test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_firewall_group_rules
  # List Firewall Rules
  ...
  describe 'list_firewall_group_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_firewall_groups
  ...
  describe 'list_firewall_groups test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for post_firewalls_firewall_group_id_rules
  ...
  # @return [PostFirewallsFirewallGroupIdRules201Response]
  describe 'post_firewalls_firewall_group_id_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for update_firewall_group
  ...
  # @return [nil]
  describe 'update_firewall_group test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
