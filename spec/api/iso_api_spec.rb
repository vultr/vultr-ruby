...
# Unit tests for VultRuby::IsoApi
...
describe 'IsoApi' do
  ...
  describe 'test an instance of IsoApi' do
    it 'should create an instance of IsoApi' do
      expect(@api_instance).to be_instance_of(VultRuby::IsoApi)
    end
  end

  # unit tests for create_iso
  # Create ISO
  ...
  describe 'create_iso test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_iso
  # Delete ISO
  # Delete an ISO.
  # @param iso_id The [ISO id](#operation/list-isos).
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_iso test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for iso_get
  # Get ISO
  # Get information for an ISO.
  # @param iso_id The [ISO id](#operation/list-isos).
  # @param [Hash] opts the optional parameters
  # @return [CreateIso201Response]
  describe 'iso_get test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_isos
  # List ISOs
  ...
  describe 'list_isos test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_public_isos
  # List Public ISOs
  # List all Vultr Public ISOs.
  # @param [Hash] opts the optional parameters
  # @return [ListPublicIsos200Response]
  describe 'list_public_isos test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
