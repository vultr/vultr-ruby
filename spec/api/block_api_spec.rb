...
# Unit tests for VultRuby::BlockApi
...
describe 'BlockApi' do
  ...
  describe 'test an instance of BlockApi' do
    it 'should create an instance of BlockApi' do
      expect(@api_instance).to be_instance_of(VultRuby::BlockApi)
    end
  end

  # unit tests for attach_block
