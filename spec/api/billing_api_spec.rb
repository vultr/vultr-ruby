...
# Unit tests for VultRuby::BillingApi
...
describe 'BillingApi' do
  ...
  describe 'test an instance of BillingApi' do
    it 'should create an instance of BillingApi' do
      expect(@api_instance).to be_instance_of(VultRuby::BillingApi)
    end
  end
  ...
  # unit tests for list_billing_history
  # List Billing History
  # Retrieve list of billing history
  # @param [Hash] opts the optional parameters
  # @return [ListBillingHistory200Response]
  describe 'list_billing_history test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
