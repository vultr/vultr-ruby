...
# Unit tests for VultRuby::ContainerRegistryApi
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe 'ContainerRegistryApi' do
  before do
  ...
  describe 'test an instance of ContainerRegistryApi' do
    it 'should create an instance of ContainerRegistryApi' do
      expect(@api_instance).to be_instance_of(VultRuby::ContainerRegistryApi)
    end
  end
  ...
  # unit tests for create_registry_docker_credentials
  # Create Docker Credentials
  # Create a fresh set of Docker Credentials for this Container Registry Subscription
  # @param registry_id The [Registry ID](#components/schemas/registry/properties/id). Which can be found by [List Registries](#operation/list-registries).
  # @param [Hash] opts the optional parameters
  ...
  describe 'create_registry_docker_credentials test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for create_registry_kubernetes_docker_credentials
  ...
  describe 'create_registry_kubernetes_docker_credentials test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param registry_id The [Registry ID](#components/schemas/registry/properties/id). Which can be found by [List Registries](#operation/list-registries).
  # @param repository_image The [Repository Image](#components/schemas/registry-repository/properties/image). Which can be found by [List Repositories](#operation/list-registry-repositories).
  # @param [Hash] opts the optional parameters
  # @return [nil]
  ...
  describe 'read_registry_repository test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
