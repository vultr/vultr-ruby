...
# Unit tests for VultRuby::PlansApi
...
describe 'PlansApi' do
  ...
  describe 'test an instance of PlansApi' do
    it 'should create an instance of PlansApi' do
      expect(@api_instance).to be_instance_of(VultRuby::PlansApi)
    end
  end

  # unit tests for list_metal_plans
  ...
  describe 'list_metal_plans test' do
    it 'should work' do
