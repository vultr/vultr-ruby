...
# Unit tests for VultRuby::LoadBalancerApi
...
describe 'LoadBalancerApi' do
  ...
  describe 'test an instance of LoadBalancerApi' do
    it 'should create an instance of LoadBalancerApi' do
      expect(@api_instance).to be_instance_of(VultRuby::LoadBalancerApi)
    end
  end
  ...
  # unit tests for create_load_balancer_forwarding_rules
  ...
  # @return [nil]
  describe 'create_load_balancer_forwarding_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for delete_load_balancer_forwarding_rule
  ...
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_load_balancer_forwarding_rule test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for delete_load_balancer_ssl
  # Delete Load Balancer SSL
  # Delete a Load Balancer SSL.
  # @param load_balancer_id The [Load Balancer id](#operation/delete-load-balancer-ssl).
  # @param [Hash] opts the optional parameters
  # @return [nil]
  describe 'delete_load_balancer_ssl test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for get_load_balancer_forwarding_rule
  # Get Forwarding Rule
  ...
  describe 'get_load_balancer_forwarding_rule test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_loadbalancer_firewall_rule
  # Get Firewall Rule
  ...
  describe 'get_loadbalancer_firewall_rule test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_load_balancer_forwarding_rules
  ...
  describe 'list_load_balancer_forwarding_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for list_loadbalancer_firewall_rules
  # List Firewall Rules
  ...
  # @option opts [String] :cursor Cursor for paging. See [Meta and Pagination](#section/Introduction/Meta-and-Pagination).
  # @return [LoadbalancerFirewallRule]
  describe 'list_loadbalancer_firewall_rules test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
