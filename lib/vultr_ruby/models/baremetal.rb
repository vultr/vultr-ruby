...
module VultrRuby
  ...
  class Baremetal
    ...
    attr_accessor :v6_network

    # The main IPv6 network address.
    attr_accessor :v6_main_ip

    # The IPv6 subnet.
    attr_accessor :v6_network_size
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::Baremetal` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::Baremetal`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'v6_network')
        self.v6_network = attributes[:'v6_network']
      end

      if attributes.key?(:'v6_main_ip')
        self.v6_main_ip = attributes[:'v6_main_ip']
      end

      if attributes.key?(:'v6_network_size')
        self.v6_network_size = attributes[:'v6_network_size']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          app_id == o.app_id &&
          image_id == o.image_id &&
          v6_network == o.v6_network &&
          v6_main_ip == o.v6_main_ip &&
          v6_network_size == o.v6_network_size &&
    ...
    def hash
      [id, os, ram, disk, main_ip, cpu_count, region, default_password, date_created, status, netmask_v4, gateway_v4, plan, label, tag, os_id, app_id, image_id, v6_network, v6_main_ip, v6_network_size, mac_address, tags, user_scheme].hash
    end
