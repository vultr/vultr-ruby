  ...
  class PostFirewallsFirewallGroupIdRulesRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::PostFirewallsFirewallGroupIdRulesRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::PostFirewallsFirewallGroupIdRulesRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'subnet_size')
        self.subnet_size = attributes[:'subnet_size']
      else
        self.subnet_size = nil
      end
    ...
    def list_invalid_properties
      ...
      if @ip_type.nil?
        invalid_properties.push('invalid value for "ip_type", ip_type cannot be nil.')
      end
      ...
      if @subnet_size.nil?
        invalid_properties.push('invalid value for "subnet_size", subnet_size cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @ip_type.nil?
      return false if @protocol.nil?
      return false if @subnet.nil?
      return false if @subnet_size.nil?
      true
    end
    ...
    def hash
      [ip_type, protocol, subnet, subnet_size, port, source, notes].hash
    end
