  ...
  class FirewallGroup
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::FirewallGroup` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::FirewallGroup`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'max_rule_count')
        self.max_rule_count = attributes[:'max_rule_count']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          max_rule_count == o.max_rule_count
    end
    ...
    def hash
      [id, description, date_created, date_modified, instance_count, rule_count, max_rule_count].hash
    end
