...
module VultrRuby
  ...
  class VkeCluster
    ...
    attr_accessor :cluster_subnet

    # IP range that services will run on this cluster
    attr_accessor :service_subnet
    ...
    attr_accessor :ha_controlplanes
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::VkeCluster` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::VkeCluster`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'cluster_subnet')
        self.cluster_subnet = attributes[:'cluster_subnet']
      end

      if attributes.key?(:'service_subnet')
        self.service_subnet = attributes[:'service_subnet']
      end
      ...
      if attributes.key?(:'ha_controlplanes')
        self.ha_controlplanes = attributes[:'ha_controlplanes']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          cluster_subnet == o.cluster_subnet &&
          service_subnet == o.service_subnet &&
          ip == o.ip &&
          endpoint == o.endpoint &&
          version == o.version &&
          region == o.region &&
          status == o.status &&
          ha_controlplanes == o.ha_controlplanes &&
    ...
    def hash
      [id, firewall_group_id, label, date_created, cluster_subnet, service_subnet, ip, endpoint, version, region, status, ha_controlplanes, node_pools].hash
    end
