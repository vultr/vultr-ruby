...
module VultrRuby
  ...
  class DbaasAlerts
    ...
    attr_accessor :maintenance_scheduled
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::DbaasAlerts` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::DbaasAlerts`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'maintenance_scheduled')
        self.maintenance_scheduled = attributes[:'maintenance_scheduled']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          maintenance_scheduled == o.maintenance_scheduled &&
    ...
    def hash
      [timestamp, message_type, description, recommendation, maintenance_scheduled, resource_type, table_count].hash
    end
