...
module VultrRuby
  ...
  class BackupSchedule
    ...
    attr_accessor :next_scheduled_time_utc
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::BackupSchedule` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::BackupSchedule`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'next_scheduled_time_utc')
        self.next_scheduled_time_utc = attributes[:'next_scheduled_time_utc']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          enabled == o.enabled &&
          type == o.type &&
          next_scheduled_time_utc == o.next_scheduled_time_utc &&
          hour == o.hour &&
          dow == o.dow &&
          dom == o.dom
    end
    ...
    def hash
      [enabled, type, next_scheduled_time_utc, hour, dow, dom].hash
    end
