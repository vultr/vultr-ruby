...
module VultrRuby
  ...
  class Blockstorage
    ...
    attr_accessor :attached_to_instance
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::Blockstorage` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::Blockstorage`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'attached_to_instance')
        self.attached_to_instance = attributes[:'attached_to_instance']
      end
      ...
      if attributes.key?(:'mount_id')
        self.mount_id = attributes[:'mount_id']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          size_gb == o.size_gb &&
          region == o.region &&
          attached_to_instance == o.attached_to_instance &&
    ...
    def hash
      [id, cost, status, size_gb, region, attached_to_instance, date_created, label, mount_id].hash
    end
