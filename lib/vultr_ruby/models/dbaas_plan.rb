  ...
  class DbaasPlan
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::DbaasPlan` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::DbaasPlan`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'number_of_nodes')
        self.number_of_nodes = attributes[:'number_of_nodes']
      end
      ...
      if attributes.key?(:'supported_engines')
        self.supported_engines = attributes[:'supported_engines']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          id == o.id &&
          number_of_nodes == o.number_of_nodes &&
          type == o.type &&
    ...
    def hash
      [id, number_of_nodes, type, vcpu_count, ram, disk, monthly_cost, supported_engines, max_connections, locations].hash
    end
