...
module VultrRuby
  class DatabaseStartMigrationRequest
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::DatabaseStartMigrationRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::DatabaseStartMigrationRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'ignored_databases')
        self.ignored_databases = attributes[:'ignored_databases']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          password == o.password &&
          database == o.database &&
          ignored_databases == o.ignored_databases &&
          ssl == o.ssl
    end
    ...
    def hash
      [host, port, username, password, database, ignored_databases, ssl].hash
    end
