  ...
  class Loadbalancer
    ...
    def self.openapi_types
      {
        ...
        :'ipv4' => :'String',
        :'ipv6' => :'String',
        :'generic_info' => :'LoadbalancerGenericInfo',
        :'health_check' => :'LoadbalancerHealthCheck',
        :'has_ssl' => :'Boolean',
        :'http2' => :'Boolean',
        :'nodes' => :'Integer',
        :'forward_rules' => :'Array<LoadbalancerForwardRulesInner>',
        :'instances' => :'Array<String>',
        :'firewall_rules' => :'Array<LoadbalancerFirewallRulesInner>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::Loadbalancer` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::Loadbalancer`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'generic_info')
        self.generic_info = attributes[:'generic_info']
      end
      ...
      if attributes.key?(:'has_ssl')
        self.has_ssl = attributes[:'has_ssl']
      end
      ...
      if attributes.key?(:'forward_rules')
        if (value = attributes[:'forward_rules']).is_a?(Array)
          self.forward_rules = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          ipv4 == o.ipv4 &&
          ipv6 == o.ipv6 &&
          generic_info == o.generic_info &&
          health_check == o.health_check &&
          has_ssl == o.has_ssl &&
          http2 == o.http2 &&
          nodes == o.nodes &&
          forward_rules == o.forward_rules &&
    ...
    def hash
      [id, date_created, region, label, status, ipv4, ipv6, generic_info, health_check, has_ssl, http2, nodes, forward_rules, instances, firewall_rules].hash
    end
