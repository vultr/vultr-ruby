...
module VultrRuby
  class CreateLoadBalancerRequest
    ...
    attr_accessor :balancing_algorithm
    ...
    def self.openapi_types
      {
        ...
        :'health_check' => :'CreateLoadBalancerRequestHealthCheck',
        :'forwarding_rules' => :'Array<CreateLoadBalancerRequestForwardingRulesInner>',
        :'sticky_session' => :'CreateLoadBalancerRequestStickySession',
        :'ssl' => :'CreateLoadBalancerRequestSsl',
        :'label' => :'String',
        :'instances' => :'Array<String>',
        :'firewall_rules' => :'Array<CreateLoadBalancerRequestFirewallRulesInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `VultrRuby::CreateLoadBalancerRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `VultrRuby::CreateLoadBalancerRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'balancing_algorithm')
        self.balancing_algorithm = attributes[:'balancing_algorithm']
      end

      if attributes.key?(:'ssl_redirect')
        self.ssl_redirect = attributes[:'ssl_redirect']
      end
      ...
      if attributes.key?(:'forwarding_rules')
        if (value = attributes[:'forwarding_rules']).is_a?(Array)
          self.forwarding_rules = value
        end
      end

      if attributes.key?(:'sticky_session')
        self.sticky_session = attributes[:'sticky_session']
      end
      ...
      if attributes.key?(:'private_network')
        self.private_network = attributes[:'private_network']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          region == o.region &&
          balancing_algorithm == o.balancing_algorithm &&
          ssl_redirect == o.ssl_redirect &&
          http2 == o.http2 &&
          nodes == o.nodes &&
          proxy_protocol == o.proxy_protocol &&
          health_check == o.health_check &&
          forwarding_rules == o.forwarding_rules &&
          sticky_session == o.sticky_session &&
          ssl == o.ssl &&
          label == o.label &&
          instances == o.instances &&
          firewall_rules == o.firewall_rules &&
          private_network == o.private_network &&
          vpc == o.vpc
    end
    ...
    def hash
      [region, balancing_algorithm, ssl_redirect, http2, nodes, proxy_protocol, health_check, forwarding_rules, sticky_session, ssl, label, instances, firewall_rules, private_network, vpc].hash
    end
